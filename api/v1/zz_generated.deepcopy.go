...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BotChannels) DeepCopyInto(out *BotChannels) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BotChannels.
func (in *BotChannels) DeepCopy() *BotChannels {
	if in == nil {
		return nil
	}
	out := new(BotChannels)
